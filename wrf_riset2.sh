#!/bin/bash
#SBATCH --job-name=riset2_wrf       #passed by script
#SBATCH --nodes=10                #passed by script
#SBATCH --ntasks-per-node=96
#SBATCH --time=72:00:00
#SBATCH --output=%x_%j.out #passed by script
#SBATCH --export=ALL
...
cp utl/namelist.input_asli namelist.input
...
cp namelist.input temp/namelist.input_previous
